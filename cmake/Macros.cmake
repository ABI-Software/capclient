...
FUNCTION( XRC_TO_CPP XRC_OUTPUT_DIR XRC_SRCS _OUTFILES )
	...
	message(STATUS "op: ${XRC_OUTPUT_DIR}")
	message(STATUS "srcs: ${XRC_SRCS}")
	FOREACH( XRC_SRC ${XRC_SRCS} )
		...
		message(STATUS "abs: ${XRC_SRC_ABS}")
		message(STATUS "path: ${XRC_SRC_PATH}")
		message(STATUS "file: ${XRC_SRC_FILE}")
		message(STATUS "fcn: ${XRC_SRC_FCN}")


		STRING( REPLACE "${XRC_SRC_EXT}" ".cpp" XRC_CPP_SRC "${XRC_SRC_FILE}" )
		message(STATUS "file: ${XRC_CPP_SRC}")
		...
		message(STATUS "gen: ${XRC_CPP_SRC_ABS}")
		message(STATUS "out: ${WXRC_OUTPUT}")
