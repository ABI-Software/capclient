...
//{
//public:
//	IsoSurfaceCapture(void* imageSet, HeartModel* heartModelPtr, Cmiss_context_id context, Cmiss_time_keeper_id timeKeeper)
//	:
...
//		
//		size_t const numberOfFrames = 1;//--imageSet_->GetNumberOfFrames();
