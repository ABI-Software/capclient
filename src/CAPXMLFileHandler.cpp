...
//std::string const& CAPXMLFileHandler::GetExelemFileName() const
//{
////	CAPXMLOutput const& output = xmlFile
////	return output_.elemFileName;
//}
//
//std::vector<std::string> CAPXMLFileHandler::GetExnodeFileNames() const
//{
...
//}
//
//double CAPXMLFileHandler::GetFocalLength() const
//{
////	return output_.focalLength;
//}
//
//void CAPXMLFileHandler::GetTransformationMatrix(gtMatrix& mat) const
//{
